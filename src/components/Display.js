...
const Display = ({ title, image, price, description }) => {
    return (
        <div className="flex flex-col items-start justify-center w-fit m-2 bg-white px-3 border rounded-md shadow-md transition-all ease-in duration-100 hover:scale-105">
